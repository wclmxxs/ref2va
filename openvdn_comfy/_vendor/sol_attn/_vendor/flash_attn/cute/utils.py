...
from openvdn_comfy._vendor.sol_attn.sm90._compat import activation
...
def fmax(
    ...
    # Ref2VA pins CuTe 4.6.0.dev0, whose NVVM binding infers the result type
    # even with CUDA 12.9. The CUDA version does not select this Python API.
    return Float32(
        nvvm.fmax(
