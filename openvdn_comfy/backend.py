...
def startup_settings():
    ...
    return Settings(
        ...
        sol_tau=float(os.environ.get("REF2VA_SOL_TAU", "1.0")),
        sol_dense_steps=int(os.environ.get("REF2VA_SOL_DENSE_STEPS", "1")),
        sol_dense_layers=int(os.environ.get("REF2VA_SOL_DENSE_LAYERS", "2")),
